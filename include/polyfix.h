...
#define polyfixveck_sub HAETAE_NAMESPACE(polyfixveck_sub)
...
void polyfixfixveck_sub(polyfixveck *w, const polyfixveck *u,
                        const polyfixveck *v);
#define polyfixveck_dobule HAETAE_NAMESPACE(polyfixveck_double)
...
#define polyfixvecl_sub HAETAE_NAMESPACE(polyfixvecl_sub)
...
void polyfixfixvecl_sub(polyfixvecl *w, const polyfixvecl *u,
                        const polyfixvecl *v);
#define polyfixvecl_dobule HAETAE_NAMESPACE(polyfixvecl_double)
