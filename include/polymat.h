...
#define polymatkm_pointwise_montgomery HAETAE_NAMESPACE(polymatkm_pointwise_montgomery)
void polymatkm_pointwise_montgomery(polyveck *t, const polyvecm mat[K], const polyvecm *v);

#define polymatkl_pointwise_montgomery HAETAE_NAMESPACE(polymatkl_pointwise_montgomery)
void polymatkl_pointwise_montgomery(polyveck *t, const polyvecl mat[K], const polyvecl *v);

#define polymatkl_double HAETAE_NAMESPACE(polymatkl_double)
void polymatkl_double(polyvecl mat[K]);

#define polymatkm_double HAETAE_NAMESPACE(polymatkm_double)
void polymatkm_double(polyvecm mat[K]);
#endif
